...
void endGame(Graphics g) {
  ...
  String message = "Game over with: " + (snake.getJoints() - 3) + " points";
...
class BackgroundPane extends JPanel {
	  ...
	  private Food f;
	  public BackgroundPane(Food f) {
	    try {
	      bg = ImageIO.read(new File("C:\\Users\\kosta\\Downloads\\reindeer.jpg"));
	    } catch (Exception ex) {
	      ex.printStackTrace();
	    }
	  ...
	  protected void paintComponent(Graphics g) {
	    ...
	    g2d.drawImage(bg, xPos, yPos, 50, 50, this);
	  }
